...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try{
        ...
        resultado.forEach((product) => {
            ...
            <div class="card col-12 col-md-4 col-xl-3 mx-3 my-3">
                <img class="card-img-top" src="images/${product.image}" alt="${product.image}" >
                <div class="card-body">
                <h5 class="card-title fs-2 fw-bold">${product.name}</h5>
                <p class="card-text">${product.description}</p>
                <a href="/producto/${product.id}" class="btn btn-primary d-block my-3">Ver Producto</a>
            ...
            const contenedor = document.getElementById('contenedor-ultimos-productos');
